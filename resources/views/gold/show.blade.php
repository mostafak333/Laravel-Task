        ...
        <div class=" container w-80 display-7 fs-5">
            <table class="table table-striped table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        @php
                        $tre=DB::select("SELECT `karat` FROM `bar` WHERE `id`=$gold->barId");
                        $locationid=DB::select("SELECT `location` FROM `treasury` WHERE `id`=$gold->treasuryId");
                        $data=$locationid[0]->location;
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="col">
                                    <form action="/gold/{{$gold->id}}/edit">
                                        <button   class="btn btn-warning"  type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 20">
